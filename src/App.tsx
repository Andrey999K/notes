...
export const NotesContext: React.Context<undefined | NotesContextType> =
  createContext(undefined);

const filterSearch = (listNotes: ListItemDate[], search: string) => {
  console.log(search);
  return search
...
function App() {
  ...
  const [noteList, setNoteList] = useState(filterSearch(noteListData, search));

  useEffect(() => {
    setNoteList(filterSearch(noteListData, search));
  }, [search]);

  return (
    <ThemeContext.Provider value={{ currentTheme, setCurrentTheme }}>
      <NotesContext.Provider value={{ setNoteList }}>
